...
public class WarmUpTask {
    ...
    public static void main(String[] args) {
        ...
        byte AgeOfAlcohol = 24;

        if (AgeOfAlcohol >= 21){
            System.out.println("He/She is permitted to drink");
        }
        if (AgeOfAlcohol < 21){
            System.out.println("He/She is not permitted to drink");
        }
        System.out.println("=============================================================================");

        /*   HTTP is the protocol that governs communications between web servers and web clients (i.e. browsers).
         Part of the protocol includes a status code returned by the server to tell the browser the status of its most
