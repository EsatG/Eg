...
so display message "Backyard is not available for condo!", (don't increase property price!),
 in case someone would try to select backyard for condo.  Then ask user for garage presence.
  ...
  add to the property price 4000.  Then your program should ask about nearest school rating.
  If school's rating is in the range from 10 (inclusive) to 8 points,
  add to the property price 45000. If school's rating is less than 8 points and more or
  equals to 4 points,  add to the property price 20000.
...
Your estimate market price is:  430000$
        ...
        if (houseType.equalsIgnoreCase("condo")){
            ...
            System.out.println("Invalid Entry, Please Enter \"condo\" or \"Townhouse\" or \"Single Family home\"");
            System.exit(0);
        }
        propertyPrice += numberOfBedrooms *  30000;


        if ((houseType.equalsIgnoreCase("Townhouse") || houseType.equalsIgnoreCase("Single Family Home")) &&  backyard ){
