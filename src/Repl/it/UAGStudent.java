...
Write a static method called "newPrincipal" that returns nothing and takes in one String parameters
that represents the new principal's name.  Set the static variable principalName to the new principal's name.
...
class Objects{
    ...
    public static void main(String[] args) {
        ...
        UAGStudent s1 = new UAGStudent("Esat",4);
        UAGStudent s2 = new UAGStudent("andi",3);

        UAGStudent.resetID();

        UAGStudent s3 = new UAGStudent("Omer",6);
