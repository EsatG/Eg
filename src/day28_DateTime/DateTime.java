...
public class DateTime {
    public static void main(String[] args) {
        ...
        // LocalDateTime dt = LocalDateTime.of(year, months, days, hours, minutes, seconds)
        ...
        LocalDateTime dateTime2 = LocalDateTime.of(2020,5,22,11,25,30);
        System.out.println(dateTime2);

        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("MM/dd/yyyy");    // 03/20/2019
